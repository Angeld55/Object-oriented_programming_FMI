...
**Задача 1:** Да се напише функции, които запазват/четат масиви от обекти, които не използват динамична памет.

**Задача 2:** Да се напише функции, която намира големината на файл.
