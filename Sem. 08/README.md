...
int main()
{
 ...
 ```
  **Задача 3:**
 Релизирайте клас - множество(без повторение) от думи. В колекцията ви търсенето трябва да е с логаритмична сложност.
...
- << (поток за вход. Първо се приема N и после N последователни думи, които да се добавят в речника).
