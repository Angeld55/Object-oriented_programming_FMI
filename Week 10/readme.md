...
int main()
{
 ...
 ```
 **Задача 2:**
 Имплементирайте клас за множество от естествени числа по критерии. Класът трябва да приема в конструктора цяло число - максималното число, което да се запази в множеството и две булеви функции: за включване на число (тези, които да са елементи на множеството) и изключване на число(тези, които първата функция връща истина, но искаме да не ги поставим в множеството). Едно цяло число е в множеството, когато **функията за включване връща истина** за него и **ф-ята на изключване връща лъжа** за него. Трябва да имате функции за проверка дали число е в множеството (за константно време), за връщане на броя на елементите и за принтиране на множеството.
