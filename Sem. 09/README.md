...
int main()
{
 ...
 ```
 **Задача 4:**
 Създайте **шаблонна** опашка с k приоритета. При взимане на елемент от опашката трябва да се връща най-отдавна добавеният елемент от тези с най-висок приоритет.
