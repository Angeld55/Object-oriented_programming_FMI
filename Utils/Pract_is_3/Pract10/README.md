...
calculate_interest(): Начислява лихва към баланса на акаунта и я добавя към баланса.
...
`LoanAccount`: Разширява BankAccount, добавяйки лихва за заем. Лихвата се начислява годишно.
Методи:
accrue_interest(): Пресмята и добавя лихвата към баланса на акаунта за заеми (спрямо лихвения процент)
